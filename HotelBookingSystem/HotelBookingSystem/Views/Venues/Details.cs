    ...
    public class Details : View
    {
        ...
        protected override void BuildViewResult(StringBuilder viewResult)
        {
            ...
            viewResult.AppendLine(venue.Name)
                .AppendFormat("Located at {0}", venue.Address)
                .AppendLine()
                .AppendFormat("Description: {0}", venue.Description)
                .AppendLine();
            if (!venue.Rooms.Any())
            {
            ...
            else
            {
                ...
                {
                    viewResult.AppendFormat(" * {0} places (${1:F2} per day)", room.Places, room.PricePerDay)
                        .AppendLine();
                }
            }
        }
